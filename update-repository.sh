...
echo "Would you like to use the custom dpkg-scanpackages created by saurik? This might not work on macOS."
select yn in "Yes" "No"; do
case $yn in
Yes ) ./custom-dpkg-scanpackages debs > Packages; break;;
No ) dpkg-scanpackages debs > Packages; break;;
esac
done
